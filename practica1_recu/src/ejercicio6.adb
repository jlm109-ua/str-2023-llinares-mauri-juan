...
procedure ejercicio6 is
   subtype T_Digito is Integer range 0..9;-- crear instancia del paquete genérico predefinido
...
-- Este programa crea números aleatorios constantemente entre el 0 y el 9. Se instancia un paquete con el que generar los números a partir de la unidad de librería Ada.Numerics.Discrete_Random.
